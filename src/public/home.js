...
socketClient.on("messagesChat", (data) => {
    ...
    data.forEach(element => {
        message += `<p><span style="font-weight:bold; color:blue">${element.author}</span> [<span style="color:brown">${element.date}</span>] : <span style="color:green; font-style:italic">${element.text}</span></p>`
    });
